...
func (db *Database) loadLayers() layer {
	...
	_, root := rawdb.ReadAccountTrieNode(rawdb.TryShardingByTriePath(db.diskdb, nil), nil)
...
func (db *Database) Journal(root common.Hash) error {
	...
	_, diskroot := rawdb.ReadAccountTrieNode(rawdb.TryShardingByTriePath(db.diskdb, nil), nil)
