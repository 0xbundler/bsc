...
func (db *Database) loadLayers() layer {
	...
	_, root := rawdb.ReadAccountTrieNode(rawdb.TryShardingByHash(db.diskdb, common.Hash{}), nil)
...
func (db *Database) Journal(root common.Hash) error {
	...
	_, diskroot := rawdb.ReadAccountTrieNode(rawdb.TryShardingByHash(db.diskdb, common.Hash{}), nil)
